    ...
    <x-filament::section>
        ...
        <div class="text-center">
            <div class="inline-flex items-center justify-center w-24 h-24 mx-auto mb-4
                ...
                rounded-full">
                @if($color === 'red')
                    <svg style="width:3rem;height:3rem" class="w-12 h-12 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @elseif($color === 'orange')
                    <svg style="width:3rem;height:3rem" class="w-12 h-12 text-orange-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                @elseif($color === 'yellow')
                    <svg style="width:3rem;height:3rem" class="w-12 h-12 text-yellow-600 dark:text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                @else
                    <svg style="width:3rem;height:3rem" class="w-12 h-12 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
